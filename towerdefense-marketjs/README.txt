...
AD INTEGRATION (for the publisher)
  ...
  1) window.gameShowAd = function () { /* show your interstitial ad */ };
     The game calls it automatically between matches (RETRY / NEXT MAP / MENU).
     It is NEVER called during a wave.
